---
title: "读《金融时报》学英文写作：定语从句——让描述更精准的高级技巧"
pubDate: 2026-05-28
description: "从IKEA取消产品目录的FT报道中，学习定语从句在英文写作中的三种高级用法：过去分词简化、现在分词简化、非限制性定语从句"
author: "William"
---
...
> IKEA is a Swedish brand **which was founded in 1943**.
> It sells furniture **that is affordable and stylish**.
> The company **which is known for its flat-pack design** has stores in many countries.
...
**例句：**
> *The decision **made by the board** has drawn criticism from employees.*
> *The changes **introduced in the new policy** aim to reduce carbon emissions.*
...
**例句：**
> *Tesla is a company **leading the transition to electric vehicles**.*
> *The new regulation, **requiring all businesses to report emissions**, takes effect next month.*
...
**例句：**
> *The app, **downloaded over a million times**, has changed how people order food.*
> *The university, **founded in 1895**, is one of the oldest in the region.*
...
2. **不要全盘替换**：有些复杂定语从句需要完整的"which + 动词"来表达（尤其是when where why引导的从句），但**70%的情况下都能简化**。
3. **三遍自查法**：
