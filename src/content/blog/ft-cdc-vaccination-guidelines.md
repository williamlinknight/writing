---
title: "读外刊学写作 | CDC疫苗指引：如何用逻辑连接词构建“对比与转变”"
pubDate: 2026-06-04
description: "分析FT关于CDC疫苗指引的报道，学习如何通过 'Until now', 'marks a departure from', 'However' 构建清晰的叙事逻辑，提升写作的衔接分。"
author: "威廉"
---
...
今天我们分析《金融时报》(FT) 关于美国 CDC 发布疫苗接种指引的报道，看看它是如何通过**时间对比**和**立场转变**的连接词，引导读者理解政策变化的。
...
**中文翻译：**
美国疾病控制和预防中心(CDC)周一发布新的指引，表示完成新冠疫苗接种的人现在可以互相在室内见面，不需要保持社交距离或戴口罩。
...
## 🚀 实践练习
试着描述“人们对待远程办公的态度转变”：
1. (过去) 过去，大多数公司认为远程办公会降低效率。
2. (转变) 但疫情后的实践标志着这种看法的转变。
3. (限制) 然而，完全取消办公室仍然是不现实的。

**(参考答案：)**
*Until now, most companies believed that remote work would hinder productivity. However, the post-pandemic practice marks a departure from that stance. Nevertheless, completely eliminating physical offices remains unrealistic.*
