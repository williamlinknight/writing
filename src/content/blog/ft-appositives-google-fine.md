---
title: "读《金融时报》学英文写作：用同位语让句子信息翻倍——从谷歌反垄断案学3个实战技巧"
pubDate: 2026-05-31
description: "从FT报道法国对谷歌开出2.2亿欧元反垄断罚单的深度文章中，学3种同位语/插入语技巧：身份同位语、定义同位语、嵌套插入——让你的作文从'一条信息一句'变成'一句承载三层信息'。"
author: "William"
---

读《金融时报》学英文写作：用同位语让句子信息翻倍——从谷歌反垄断案学3个实战技巧

为什么中国学生的英语作文总是"短句堆砌"？因为大脑里想的是中文——一个信息点一个短句。但英文好的写作者追求的是**信息密度**：在一个句子里塞进两个甚至三个信息层。
...
实现这种高密度写作的核心武器，就是**同位语（Appositive）和插入语（Parenthetical）**。今天我们用FT一篇关于法国对谷歌开出2.2亿欧元反垄断罚单的深度报道，学3个可以直接用在考场上的实战技巧。
...
但是作者在主语Google和谓语"had tied"之间，插入了一个长长的`which`从句——描述了谷歌在在线广告领域的统治地位。**插入语不改变句子的核心语法结构**，但可以在中间无缝塞入补充信息。
